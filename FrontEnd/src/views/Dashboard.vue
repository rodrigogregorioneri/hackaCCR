  ...
  <div>
    ...
    <CCard>
      <CCardBody>
        <CRow>
          <CCol sm="5">
            <h4 id="traffic" class="card-title mb-0">Tráfego de caminhoes</h4>
            <div class="small text-muted">Junho 2020</div>
          </CCol>
      ...
      <CCardFooter>
        <CRow class="text-center">
          <CCol md sm="12" class="mb-sm-2 mb-0">
            <div class="text-muted">Visitas aos postos CCR</div>
          ...
          <CCol md sm="12" class="mb-sm-2 mb-0 d-md-down-none">
            <div class="text-muted">Utilização do APP</div>
          ...
          <CCol md sm="12" class="mb-sm-2 mb-0">
            <div class="text-muted">Contribuição para melhorias das estradas</div>
          ...
          <CCol md sm="12" class="mb-sm-2 mb-0 d-md-down-none">
            <div class="text-muted">Melhores Caminhoneiros</div>
            ...
            <CRow>
              <CCol sm="12" lg="6">
                <CRow>
                  ...
                  <CCol sm="6">
                    <CCallout color="danger">
                      <small class="text-muted">Recorrencia de clientes</small><br>
                ...
                <div class="legend text-center">
                  <h3>Ranking dos melhores caminhoneiros (Tubarões)</h3>
                </div>
              </CCol>
              <CCol sm="12" lg="6">
                <CRow>
                  ...
                  <CCol sm="6">
                    <CCallout color="success">
                      <small class="text-muted">Organico</small><br>
                ...
                <ul class="horizontal-bars type-2">
                  ...
                  <div class="progress-group">
                    <div class="progress-group-header">
                      ...
                      <span class="title">Pesquisa Organica</span>
